...
(def ^:private sentry-uncaught-exception-handler
  (reify Thread$UncaughtExceptionHandler
    (uncaughtException [_ _ exception]
      (report-error exception "An uncaught error in Sentry worker"))))
...
(defn- ^ThreadFactory thread-factory [name-format]
  (-> (ThreadFactoryBuilder.)
      ...
      (.setUncaughtExceptionHandler sentry-uncaught-exception-handler)
      (.build)))
